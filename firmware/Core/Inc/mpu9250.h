 ...
 */
typedef enum {
	GYRO_RANGE_250DPS = 0,/**< GYRO_RANGE_250DPS */
	GYRO_RANGE_500DPS,    /**< GYRO_RANGE_500DPS */
	GYRO_RANGE_1000DPS,   /**< GYRO_RANGE_1000DPS */
	GYRO_RANGE_2000DPS    /**< GYRO_RANGE_2000DPS */
 ...
 */
typedef enum {
	ACCEL_RANGE_2G = 0,/**< ACCEL_RANGE_2G */
	ACCEL_RANGE_4G,    /**< ACCEL_RANGE_4G */
	ACCEL_RANGE_8G,    /**< ACCEL_RANGE_8G */
	ACCEL_RANGE_16G    /**< ACCEL_RANGE_16G */
 ...
 * @param srd: Sample rate divider value
 */
void MPU_SetSampleRateDivider(mpu_sample_rate_divider_t srd);

/**MPU_SetDLPFBandwidth
 * This function sets the DLPF bandwidth
 * @param bandwidth: Bandwidth value
 */
void MPU_SetDLPFBandwidth(mpu_dlpf_bandwidth_t bandwidth);

/**MPU_SetGyroRange
 * This function sets gyroscope full scale range
 * @param range: Gyroscope range value
 */
void MPU_SetGyroRange(mpu_gyroscope_range_t range);

/**MPU_SetAccelRange
 * This function sets the accelerometer full scale range
 * @param range: Accelerometer range value
 */
void MPU_SetAccelRange(mpu_accelerometer_range_t range);
